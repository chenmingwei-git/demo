...
public class SM4Util {
     ...
     * SM4 ECB Padding加密
     */
    public static byte[] encryptSm4EcbPadding(String plainText, String charset, String key) throws Exception {
        try {
            byte[] plainTextBytes = plainText.getBytes(charset);
            byte[] keyBytes = ByteUtils.fromHexString(key);
            return SM4Util.encrypt_Ecb_Padding(keyBytes, plainTextBytes);
        } catch (Exception e) {
            throw new Exception("SM4 ECB Padding加密出错" + e.getMessage());
        }
    }
    ...
    public static byte[] encodeBase64(byte[] data) throws Exception {
        try {
            ...
            throw new Exception("BASE64加密出错" + e.getMessage());
     ...
     * SM4 ECB Padding解密
     */
    public static byte[] decryptSm4EcbPadding(byte[] data, String charset, String key) throws Exception {
        try {
            byte[] keyBytes = ByteUtils.fromHexString(key);
            return SM4Util.decrypt_Ecb_Padding(keyBytes, data);
        } catch (Exception e) {
            throw new Exception("SM4 ECB Padding解密出错" + e.getMessage());
        }
    }

    public static byte[] decodeBase64(String cipherText, String charset) throws Exception {
        try {
            byte[] data = cipherText.getBytes(charset);
            return Base64.decode(data);
        } catch (Exception e) {
            throw new Exception("BASE64解密出错" + e.getMessage());
        }
    }
